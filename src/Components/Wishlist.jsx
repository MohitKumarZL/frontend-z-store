    ...
    <>
      <div className='max-w-5xl px-5 py-10 mx-auto'>
        ...
        <div className='flex justify-between items-center'>
          ...
          <span className='text-3xl font-semibold text-black'>Your Wishlist</span>

          <Link to="/cart" className='hidden sm:block text-sm text-[#748C70] hover:underline'>Order</Link>
        </div>
