...
const CollectionDropdown = () => {
  ...
  return (
    <div className=" bg-white max-w-full z-20 flex px-[7.5vw] pt-[2.222vw] pb-[1.558vw] space-y-[3.75vw] w-full border-t border-gray-300">
      <div className="grid grid-cols-3 w-1/2 ">
        ...
        <div className="space-x-5 space-y-6">
          ...
          <div className="space-y-4 text-[#404040] text-lg">
            <div>New In</div>
            <div>ZhopFest</div>
            <div><Link to="/plussize" onClick={()=>handleClick("plussize")}>Plus Size</Link></div>
            <div>Best Seller</div>
          </div>
        </div>
        <div className="space-x-5 space-y-6">
