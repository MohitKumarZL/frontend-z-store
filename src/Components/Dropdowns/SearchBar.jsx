...
const SearchBar = () => {
  return (
    <div className="absolute backdrop-blur-lg bg-white/80 max-w-full  h-full z-20 flex sm:px-[7.5vw] sm:pt-[2.222vw] py-[6vw] px-[5vw] sm:pb-[4.444vw] space-y-[3.75vw] w-full border-t border-gray-300">
